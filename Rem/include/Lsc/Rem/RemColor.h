...
//#ifndef LSC_REMCOLOR_H
//#define LSC_REMCOLOR_H
#pragma once
...
//{
//    using Dictionary = std::map<Lsc::Ansi::Color, std::string>;
//    static RemColors::Dictionary mColors;
//
//    RemColors() = default;
//    RemColors(RemColors&&) = default;
//    explicit RemColors(Lsc::Ansi::Color );
//    ~RemColors() = default;
//
//    // Call *RemColors(Ansi::Steal);
//    std::string operator *();
//
//
//};

...
/*
    BOOK (HTML)
       \  (Grandes Structures:)
        ...
        [- Legendes (Liens; Code de couleurs; Par type d'entree; Par évenement, etc... )]
...
public:
    ...
    struct APPBOOK_LIB  Log // <== Remarque ...
    {
    ...
    class APPBOOK_LIB Section
    {
        String mName;
        Book::Topic* mTopic;
        String mText; ///< Texte desciptif de la section
    public:
    ...
    class APPBOOK_LIB Topic
    {
        ...
        String mText; ///< Texte desciptif du sujet
    public:
        using Dictionary = std::map<std::string, Topic*>;
        using Shared = std::shared_ptr<Topic>;
    };
    
    class APPBOOK_LIB Article
    {
        String mTitle;
        Topic::Shared mTopic=nullptr;
    };

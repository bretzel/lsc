...
#   ifdef CRUD_DLL_EXPORT
#       define CRUD_LIB __declspec(dllexport)
#       if __GNUC__ >= 4
#           define CRUD_LIB __attribute__ ((visibility ("default")))
...
#       endif
#   else
#       define CRUD_LIB __declspec(dllimport)
#   endif
#   else
#       define CRUD_LIB    // Not ms-Windows/MSVC
#endif

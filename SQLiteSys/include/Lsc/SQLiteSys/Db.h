...
class SQLITE_LIB SchemaItem : public Object
{
    String mName;
...
*/
class SQLITE_LIB Field : public SchemaItem
{
    String mName;
...
class SQLITE_LIB Schema : public SchemaItem
{
    Table::List mTables;

...
Lsc::String& operator << (Lsc::String&, Lsc::Type::T);
std::string& operator << (std::string&, Lsc::Type::T);
Lsc::Type::T& operator << (Lsc::Type::T& T_, const std::string& TStr_);
//std::ostream& operator << (std::ostream&, Lsc::Mnemonic);
//
//std::istringstream& operator << (std::istringstream& , Lsc::Type::T);
//std::istringstream& operator << (std::istringstream&, Lsc::Mnemonic);

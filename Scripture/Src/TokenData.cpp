...
static TokenData::Collection tokens_table = {{Mnemonic::Knull,        Type::Keyword,     0x000040000,  Type::Delta::Identifier, Lexem::Knull,        1},
                                             ...
                                             {Mnemonic::Closeabs,     Type::ClosePair,   0x080400000,  Type::Delta::Par,        Lexem::Closeabs,     1},
                                             ...
                                             {Mnemonic::Closepar,     Type::ClosePair,   0x1080400000, Type::Delta::Par,        Lexem::Closepar,     1},
                                             {Mnemonic::Openindex,    Type::Binary,      0x2080C00000, Type::Delta::Par,        Lexem::Openindex,    1},
                                             {Mnemonic::Closeindex,   Type::ClosePair,   0x4080400000, Type::Delta::Par,        Lexem::Closeindex,   1},
                                             {Mnemonic::Openbrace,    Type::Binary,      0x880C00000,  Type::Delta::Par,        Lexem::Openbrace,    1},
                                             {Mnemonic::Closebrace,   Type::ClosePair,   0x1080400000, Type::Delta::Par,        Lexem::Closebrace,   1},
                                             ...
                                             {Mnemonic::Dot,          Type::Punctuation, 0x080400000,  Type::Delta::Scope,      Lexem::Dot,          1},
